...
public class virtual3 : MonoBehaviour, IVirtualButtonEventHandler
{
    ...
    void Start()
    {
        ...
        c3 = GameObject.Find("b3");
        c3.GetComponent<VirtualButtonBehaviour>().RegisterEventHandler(this);
