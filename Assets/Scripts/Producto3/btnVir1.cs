...
public class btnVir1 : MonoBehaviour, IVirtualButtonEventHandler
{
    ...
    void Start()
    {
        ...
        b1 = GameObject.Find("botoncito1");
        b1.GetComponent<VirtualButtonBehaviour>().RegisterEventHandler(this);
